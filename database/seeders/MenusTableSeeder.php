...
class MenusTableSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Menu::create(['parent_id' => $article->id, 'name' => '分类管理', 'slug' => 'article.category', 'route' => 'filament.resources.categories.index', 'permission' => 'category.view', 'sort_order' => 2, 'is_visible' => true, 'is_active' => true]);
        ...
        Menu::create(['parent_id' => $user->id, 'name' => '角色管理', 'slug' => 'user.role', 'route' => 'filament.resources.roles.index', 'permission' => 'role.view', 'sort_order' => 2, 'is_visible' => true, 'is_active' => true]);
